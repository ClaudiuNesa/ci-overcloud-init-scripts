...
scp -o "UserKnownHostsFile /dev/null" -o "StrictHostKeyChecking no" -i $LOGS_SSH_KEY "/var/lib/jenkins/jenkins-master/logs/console-$NAME.log.gz" logs@logs.openstack.tld:/srv/logs/$ZUUL_CHANGE/$ZUUL_PATCHSET/console.log.gz && rm -f /var/lib/jenkins/jenkins-master/logs/console-$NAME.log.gz
gzip -9 /var/lib/jenkins/jenkins-master/logs/console-$CINDER_VM_NAME.log
scp -o "UserKnownHostsFile /dev/null" -o "StrictHostKeyChecking no" -i $LOGS_SSH_KEY "/var/lib/jenkins/jenkins-master/logs/console-$CINDER_VM_NAME.log.gz" logs@logs.openstack.tld:/srv/logs/$ZUUL_CHANGE/$ZUUL_PATCHSET/console-cinder.log.gz && rm -f /var/lib/jenkins/jenkins-master/logs/console-$$CINDER_VM_NAME.log.gz
